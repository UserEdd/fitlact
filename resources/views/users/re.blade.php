        ...
        <div class="col-md-4 mx-auto">
            <form action="{{ route('user.registro') }}" method="post">
                ...
                <div class="form-group mb-2">
                    ...
                    @error('name')
                        <p class="text-danger">{{ "Solo se aceptan letras" }}</p>
                    @enderror
                </div>
                <div class="form-group mb-2">
                    <label>Apellidos</label>
                    <input type="text" name="apellidos" class="form-control mt-1" required>  
                    @error('apellidos')
                        <p class="text-danger">{{ "Solo se aceptan letras" }}</p>
                    @enderror
                </div>
                ...
                <div class="text-center mt-2">
                    <input type="submit" value="REGISTRARSE" class="btn btn-lg px-3 button-login">
                </div>
            </form>
        </div>
    </div>
